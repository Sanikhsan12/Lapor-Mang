      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center bg-surface-light dark:bg-surface-dark p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
          <div>
            <h1 className="text-2xl font-bold text-slate-800 dark:text-white flex items-center gap-3">
              Admin Portal
              <span
                className={`text-xs px-3 py-1 rounded-full flex items-center gap-1.5 font-bold ${socketStatus === "connected" ? "bg-green-100 text-green-700 dark:bg-green-900/20 dark:text-green-400" : "bg-red-100 text-red-700 dark:bg-red-900/20 dark:text-red-400"}`}
              >
                <Activity
                  size={14}
                  className={
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
              Lapor Mang — Live Reports Monitoring &amp; Management
            </p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={logoutAuth}
              className="flex items-center gap-2 text-red-500 hover:text-red-700 bg-red-50 dark:bg-red-900/20 px-4 py-2 rounded-lg font-medium transition-colors"
            >
              <LogOut size={20} />{" "}
        ...
        <div className="card-surface">
          ...
          >
            ...
            <button
              type="submit"
              className="btn-secondary flex items-center justify-center gap-2 py-2.5 w-full sm:w-auto px-6"
            >
              ...
              <div key={r.id} className="card-surface overflow-hidden p-0">
                ...
                <div className="p-5 flex flex-col sm:flex-row sm:items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <span
                        className={`text-[10px] px-3 py-1 rounded-full uppercase font-bold tracking-wider border ${getStatusColor(r.status)} whitespace-nowrap`}
                      >
                        {r.status}
                      </span>
                    ...
                    <p className="font-bold text-slate-800 dark:text-white text-base mb-1 truncate">
                      {r.title}
                    </p>
                ...
                <div className="border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/40 p-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      disabled={
                        sendingId === r.id || !responseInputs[r.id]?.trim()
                      }
